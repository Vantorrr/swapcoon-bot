...
function calculateExchange() {
    ...
    const specialCalcPairs = ['ARS/UAH', 'UAH/ARS', 'RUB/ARS', 'ARS/RUB', 'RUB/KZT', 'KZT/RUB', 'USDT/ARS', 'ARS/USDT', 'USDT/KZT', 'KZT/USDT', 'BTC/ETH', 'ETH/BTC', 'BTC/ARS', 'ARS/BTC', 'BTC/KZT', 'KZT/BTC', 'BTC/UAH', 'UAH/BTC', 'ETH/ARS', 'ARS/ETH'];
